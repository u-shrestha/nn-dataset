...
class Net(nn.Module):
    ...
    def __init__(self, in_shape: tuple, out_shape: tuple, prm: dict, device: torch.device) -> None:
        super().__init__()
        self.device = device
        self.pattern = 'Enhanced_Edge_Network'
        ...
        self.backbone_b = TorchVision('shufflenet_v2_x0_5', in_channels=3, truncate=9).to(device)
        self.features = nn.Sequential(InvertedResidualBlock(464, 128, stride=1, expansion_factor=2), SEBlock(128), InvertedResidualBlock(128, 64, stride=1, expansion_factor=2))
