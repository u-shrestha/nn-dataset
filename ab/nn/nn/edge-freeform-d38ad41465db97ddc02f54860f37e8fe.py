...
class Net(nn.Module):
    ...
    def __init__(self, in_shape: tuple, out_shape: tuple, prm: dict, device: torch.device) -> None:
        ...
        self.backbone_a = TorchVision('mobilenet_v3_small', in_channels=in_shape[1], truncate=10).to(device)
        self.features = nn.Sequential(DepthwiseSeparableConv(in_shape[1], 32, stride=1), SqueezeExcitation(32), InvertedResidual(32, 64, stride=2), DepthwiseSeparableConv(64, 64, stride=1), SqueezeExcitation(64), InvertedResidual(64, 128, stride=2))
