...
class Net(nn.Module):
    ...
    def __init__(self, in_shape: tuple, out_shape: tuple, prm: dict, device: torch.device) -> None:
        super().__init__()
        self.device = device
        self.pattern = 'Ensemble_Backbones_with_SE_and_SEPARABLE_CONV'
        ...
        self.features = nn.Sequential(InvertedResidualBlock(256, 128, expansion_factor=6, stride=1), DepthwiseSeparableConv(128, 64), SqueezeExcitation(64, reduced_dim=16))
