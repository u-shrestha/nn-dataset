...
class Net(nn.Module):
    ...
    def __init__(self, in_shape: tuple, out_shape: tuple, prm: dict, device: torch.device) -> None:
        ...
        N = 3
        num_columns = 2
        element_list = ('nn.ReLU(inplace=True)', 'nn.ReLU(inplace=True)', 'nn.ReLU(inplace=True)') # Just for logging
        backbone_a_name = "shufflenet_v2_x1_5"
        backbone_b_name = "googlenet"
