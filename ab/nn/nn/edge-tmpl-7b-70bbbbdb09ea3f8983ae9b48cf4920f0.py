...
class Head(nn.Module):
    def __init__(self, in_channels, num_classes, prm):
        ...
        self.shuffle = ShuffleUnit(128, 128, 3)
...
class ShuffleUnit(nn.Module):
    ...
    def forward(self, x):
        ...
        grouped = self.grouped_conv(split)
        merge = self.merge_conv(torch.cat([split[:, :grouped.size(1)], grouped], dim=1))
        return merge + shortcut
# =============================================================
