...
class Head(nn.Module):
    def __init__(self, in_channels, num_classes, prm):
        ...
        self.dw_conv1 = nn.Conv2d(192, 192, kernel_size=3, padding=1, groups=192, bias=False)
        self.bn_dw1 = nn.BatchNorm2d(192)
        ...
        self.conv_project = nn.Conv2d(192, 96, kernel_size=1, bias=False)
        self.bn_project = nn.BatchNorm2d(96)
    ...
    def forward(self, x):
        ...
        x = x * se_weights
        x = self.relu(self.bn_project(self.conv_project(x)))
