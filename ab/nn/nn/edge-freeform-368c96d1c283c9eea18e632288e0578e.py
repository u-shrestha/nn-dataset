...
class Net(nn.Module):
    ...
    def __init__(self, in_shape: tuple, out_shape: tuple, prm: dict, device: torch.device) -> None:
        ...
        self.features = nn.Sequential(ds_conv3x3_block(3, 64, stride=1, padding=1, bias=False, dropout_prob=dropout_prob), SEInvertedResidualBlock(64, 64, stride=2, expand_ratio=2, dropout_prob=dropout_prob), SqueezeExcitation(64), SEInvertedResidualBlock(64, 128, stride=2, expand_ratio=2, dropout_prob=dropout_prob), SqueezeExcitation(128))
        self.to(self.device)
