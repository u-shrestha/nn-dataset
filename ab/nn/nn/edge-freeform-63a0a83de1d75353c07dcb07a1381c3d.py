...
class InvertedResidualBlock(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, stride, expand_ratio):
        ...
        layers.append(DepthwiseSeparableBlock(hidden_dim, hidden_dim, stride))
...
class Net(nn.Module):
    ...
    def __init__(self, in_shape: tuple, out_shape: tuple, prm: dict, device: torch.device) -> None:
        super().__init__()
        self.device = device
        self.pattern = 'Hybrid_Backbones_InvertedResidual_SE'
        ...
        self.features = nn.Sequential(InvertedResidualBlock(512, 128, stride=2, expand_ratio=6), InvertedResidualBlock(128, 128, stride=1, expand_ratio=6), InvertedResidualBlock(128, 256, stride=2, expand_ratio=6), SqueezeExcitation(256, 256 // 4))
