...
class SEInvertedResidualBlock(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, stride=1, expansion_factor=6, dropout_prob=0.0, se_reduction=16):
        super(SEInvertedResidualBlock, self).__init__()
        hidden_dim = int(round(in_channels * expansion_factor))
        self.conv1 = nn.LazyConv2d(hidden_dim, kernel_size=1, bias=False)
        ...
        self.se = se_block(hidden_dim, reduction=se_reduction)
...
class Net(nn.Module):
    ...
    def __init__(self, in_shape: tuple, out_shape: tuple, prm: dict, device: torch.device) -> None:
        super().__init__()
        self.device = device
        self.pattern = 'Mobile_SE_Ensemble'
        ...
        self.features = nn.Sequential(SEInvertedResidualBlock(3, 16, stride=1, dropout_prob=dropout_prob), SEInvertedResidualBlock(16, 24, stride=2, dropout_prob=dropout_prob), SEInvertedResidualBlock(24, 40, stride=2, dropout_prob=dropout_prob), SEInvertedResidualBlock(40, 80, stride=2, dropout_prob=dropout_prob), SEInvertedResidualBlock(80, 96, stride=1, dropout_prob=dropout_prob), SEInvertedResidualBlock(96, 192, stride=2, dropout_prob=dropout_prob), SEInvertedResidualBlock(192, 320, stride=1, dropout_prob=dropout_prob)).to(device)
