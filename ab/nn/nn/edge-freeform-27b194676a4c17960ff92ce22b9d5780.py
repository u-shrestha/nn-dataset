...
class Net(nn.Module):
    ...
    def __init__(self, in_shape: tuple, out_shape: tuple, prm: dict, device: torch.device) -> None:
        ...
        self.features = nn.Sequential(DepthwiseSeparableConv(3, 24, stride=2), se_block(24), inverted_residual_block(24, 48, stride=2, dropout_prob=dropout_prob), se_block(48), inverted_residual_block(48, 96, stride=2, dropout_prob=dropout_prob), se_block(96))
