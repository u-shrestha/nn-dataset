...
class Net(nn.Module):
    ...
    def __init__(self, in_shape: tuple, out_shape: tuple, prm: dict, device: torch.device) -> None:
        ...
        self.features = nn.Sequential(nn.Conv2d(3, 32, kernel_size=3, stride=2, padding=1, bias=False), nn.BatchNorm2d(32), nn.ReLU6(inplace=True), InvertedResidualBlock(32, 16, stride=1, expand_ratio=1, dropout_prob=dropout_prob), InvertedResidualBlock(16, 24, stride=2, expand_ratio=6, dropout_prob=dropout_prob), InvertedResidualBlock(24, 24, stride=1, expand_ratio=6, dropout_prob=dropout_prob), SqueezeExcitation(24, 6))
