...
class Net(nn.Module):
    ...
    def __init__(self, in_shape: tuple, out_shape: tuple, prm: dict, device: torch.device) -> None:
        ...
        self.features = nn.Sequential(InvertedResidual(3, 1, 64, 2), SqueezeExcitation(64), InvertedResidual(64, 2, 128, 2), SqueezeExcitation(128), InvertedResidual(128, 2, 256, 2), SqueezeExcitation(256), nn.Dropout2d(dropout_prob))
