...
class Head(nn.Module):
    def __init__(self, in_channels, num_classes, prm):
        ...
        self.dw_conv1 = nn.Conv2d(192, 192, 3, padding=1, groups=192, bias=False)
        self.dw_bn1 = nn.BatchNorm2d(192)
        self.se_block = nn.Sequential(
            nn.AdaptiveAvgPool2d(1),
            nn.Conv2d(192, 48, 1, bias=False),
            nn.ReLU(inplace=True),
            nn.Conv2d(48, 192, 1, bias=False),
            nn.Sigmoid()
        )
        self.dw_conv2 = nn.Conv2d(192, 192, 3, padding=1, groups=192, bias=False)
        self.dw_bn2 = nn.BatchNorm2d(192)
