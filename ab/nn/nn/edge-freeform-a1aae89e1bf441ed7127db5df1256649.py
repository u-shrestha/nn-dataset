...
class Net(nn.Module):
    ...
    def __init__(self, in_shape: tuple, out_shape: tuple, prm: dict, device: torch.device) -> None:
        ...
        self.features = nn.Sequential(inverted_residual_block(3, 16, stride=1, expand_ratio=1, dropout_prob=dropout_prob), inverted_residual_block(16, 32, stride=2, expand_ratio=6, dropout_prob=dropout_prob), squeeze_excitation(32), inverted_residual_block(32, 64, stride=2, expand_ratio=6, dropout_prob=dropout_prob), squeeze_excitation(64), depthwise_separable_conv(64, 128, stride=1, dropout_prob=dropout_prob)).to(device)
