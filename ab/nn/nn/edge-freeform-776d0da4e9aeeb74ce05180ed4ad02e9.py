...
class SEBlock(nn.Module):
    ...
    def __init__(self, in_channels, reduction_ratio=16):
        ...
        self.se = nn.Sequential(nn.AdaptiveAvgPool2d(1), nn.Conv2d(in_channels, reduced_dim, kernel_size=1), nn.ReLU(inplace=True), nn.Conv2d(reduced_dim, in_channels, kernel_size=1), nn.Sigmoid())
