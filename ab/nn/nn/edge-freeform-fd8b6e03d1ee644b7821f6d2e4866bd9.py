...
class Net(nn.Module):
    ...
    def __init__(self, in_shape: tuple, out_shape: tuple, prm: dict, device: torch.device) -> None:
        ...
        self.features = nn.Sequential(nn.Conv2d(in_shape[1], 16, kernel_size=3, stride=1, padding=1, bias=False), nn.BatchNorm2d(16), nn.ReLU6(inplace=True), InvertedResidual(16, 2, 32, 2), SqueezeExcitation(32), InvertedResidual(32, 2, 64, 2), SqueezeExcitation(64), nn.Dropout2d(dropout_prob))
    ...
    def infer_dimensions_dynamically(self, in_shape, num_classes):
        ...
        with torch.no_grad():
            ...
            dim_fused = x_f.size(1) + x_a.size(1) + x_b.size(1)
