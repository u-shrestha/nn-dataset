...
class Net(nn.Module):
    ...
    def __init__(self, in_shape: tuple, out_shape: tuple, prm: dict, device: torch.device) -> None:
        ...
        self.features = nn.Sequential(inverted_residual_block(576, 128, dropout_prob=dropout_prob), SqueezeExcitation(128, reduction=4), inverted_residual_block(128, 64, dropout_prob=dropout_prob), SqueezeExcitation(64, reduction=4)).to(device)
