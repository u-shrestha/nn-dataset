...
class Net(nn.Module):
    ...
    def __init__(self, in_shape: tuple, out_shape: tuple, prm: dict, device: torch.device) -> None:
        ...
        self.features = nn.Sequential(SEInvertedResidual(3, 16, stride=1, expand_ratio=1, dropout_prob=dropout_prob), SEInvertedResidual(16, 32, stride=2, expand_ratio=6, dropout_prob=dropout_prob), SEInvertedResidual(32, 32, stride=1, expand_ratio=6, dropout_prob=dropout_prob))
