...
class Net(nn.Module):
    ...
    def __init__(self, in_shape: tuple, out_shape: tuple, prm: dict, device: torch.device) -> None:
        ...
        self.features = nn.Sequential(InvertedResidualBlock(in_channels=512, out_channels=128, expansion_factor=6, stride=1, use_se=True, se_ratio=0.25), DepthwiseSeparableBlock(in_channels=128, out_channels=64, stride=1, padding=1), SEBlock(in_channels=64, reduced_dim=16), InvertedResidualBlock(in_channels=64, out_channels=64, expansion_factor=6, stride=1, use_se=True, se_ratio=0.25))
