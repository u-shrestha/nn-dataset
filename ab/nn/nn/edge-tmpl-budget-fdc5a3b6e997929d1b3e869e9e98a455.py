...
class Head(nn.Module):
    def __init__(self, in_channels, num_classes, prm):
        ...
        self.dw_conv1 = nn.Conv2d(256, 256, kernel_size=3, padding=1, groups=256, bias=False)
        self.bn_dw1 = nn.BatchNorm2d(256)
        ...
        self.dw_conv2 = nn.Conv2d(256, 256, kernel_size=3, padding=1, groups=256, bias=False)
        self.bn_dw2 = nn.BatchNorm2d(256)
