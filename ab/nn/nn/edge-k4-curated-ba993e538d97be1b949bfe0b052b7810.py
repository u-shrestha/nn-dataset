...
class InvertedResidual(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, expansion_factor, stride):
        ...
        layers.extend([nn.Conv2d(hidden_dim, hidden_dim, 3, stride, 1, groups=hidden_dim, bias=False), nn.BatchNorm2d(hidden_dim), nn.ReLU6(inplace=True), nn.Conv2d(hidden_dim, out_channels, 1, 1, 0, bias=False), nn.BatchNorm2d(out_channels)])
...
class Net(nn.Module):
    ...
    def __init__(self, in_shape: tuple, out_shape: tuple, prm: dict, device: torch.device) -> None:
        super().__init__()
        self.device = device
        self.pattern = 'Efficient_Fusion_Backbones'
        ...
        self.features = nn.Sequential(nn.Conv2d(3, 32, kernel_size=3, stride=1, padding=1, bias=False), nn.BatchNorm2d(32), nn.ReLU(inplace=True), InvertedResidual(32, 16, expansion_factor=1, stride=1), InvertedResidual(16, 24, expansion_factor=6, stride=2), InvertedResidual(24, 24, expansion_factor=6, stride=1), InvertedResidual(24, 40, expansion_factor=6, stride=2), InvertedResidual(40, 40, expansion_factor=6, stride=1), InvertedResidual(40, 40, expansion_factor=6, stride=1), InvertedResidual(40, 80, expansion_factor=6, stride=2), InvertedResidual(80, 80, expansion_factor=6, stride=1), InvertedResidual(80, 80, expansion_factor=6, stride=1), InvertedResidual(80, 80, expansion_factor=6, stride=1), InvertedResidual(80, 112, expansion_factor=6, stride=1), InvertedResidual(112, 112, expansion_factor=6, stride=1), InvertedResidual(112, 160, expansion_factor=6, stride=2), InvertedResidual(160, 160, expansion_factor=6, stride=1), InvertedResidual(160, 160, expansion_factor=6, stride=1), nn.Conv2d(160, 960, kernel_size=1, stride=1, padding=0, bias=False), nn.BatchNorm2d(960), nn.ReLU6(inplace=True))
