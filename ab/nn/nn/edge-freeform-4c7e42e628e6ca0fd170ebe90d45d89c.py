...
class Net(nn.Module):
    ...
    def __init__(self, in_shape: tuple, out_shape: tuple, prm: dict, device: torch.device) -> None:
        ...
        self.features = nn.Sequential(depthwise_separable_block(in_channels=in_shape[1], out_channels=32, dropout_prob=dropout_prob), inverted_residual_block(in_channels=32, out_channels=64, stride=1, dropout_prob=dropout_prob), squeeze_excitation_block(in_channels=64))
