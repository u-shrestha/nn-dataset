...
class Net(nn.Module):
    """Combining elements from two references for improved performance."""
    ...
    def __init__(self, in_shape=(1, 3, 256, 256), out_shape=None, prm={}, device='cuda'):
        ...
        self.eb1 = Block(32)
        self.down1 = nn.Sequential(nn.Conv2d(32, 64, 3, stride=2, padding=1), nn.ELU(inplace=True))
        self.eb2 = Block(64)
        ...
        self.bottleneck = Block(256)
        self.upsample = nn.Upsample(scale_factor=2, mode='nearest')
        self.up3 = nn.Conv2d(256 + 128, 128, 3, padding=1)
        self.db3 = Block(128)
        self.up2 = nn.Conv2d(128 + 64, 64, 3, padding=1)
        self.db2 = Block(64)
        self.up1 = nn.Conv2d(64 + 32, 32, 3, padding=1)
        self.db1 = Block(32)
        self.up0 = nn.Conv2d(32 + 16, 16, 3, padding=1)
        self.db0 = Block(16)
