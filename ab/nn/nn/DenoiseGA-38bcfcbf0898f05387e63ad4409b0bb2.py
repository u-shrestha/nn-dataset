...
class PBlock(nn.Module):
    ...
    def __init__(self, channels):
        ...
        self.project = nn.Conv2d(hidden, channels, 5, padding=2)
...
class Net(nn.Module):
    ...
    def __init__(self, in_shape=(1, 3, 512, 512), out_shape=None, prm={}, device='cuda'):
        ...
        self.device = device
        f1, f2 = (12, 24)
        self.stem = nn.Conv2d(3, f1, 1, padding=0)
