...
class Head(nn.Module):
    def __init__(self, in_channels, num_classes, prm):
        ...
        self.squeeze = nn.Conv2d(256, 128, kernel_size=1, bias=False)
        self.bn_squeeze = nn.BatchNorm2d(128)
        self.expand = nn.Conv2d(128, 512, kernel_size=1, bias=False)
        self.bn_expand = nn.BatchNorm2d(512)
