...
class Net(nn.Module):
    ...
    def __init__(self, in_shape: tuple, out_shape: tuple, prm: dict, device: torch.device) -> None:
        ...
        self.backbone_a = TorchVision('squeezenet1_1', in_channels=3, weights='DEFAULT').to(device)
        ...
        for i, out_ch in enumerate(channels):
            ...
            curr_ch = out_ch
        self.backbone_b = TorchVision('shufflenet_v2_x1_0', in_channels=3, weights='DEFAULT').to(device)
