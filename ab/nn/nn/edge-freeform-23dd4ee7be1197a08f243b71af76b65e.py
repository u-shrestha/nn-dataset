...
class Net(nn.Module):
    ...
    def __init__(self, in_shape: tuple, out_shape: tuple, prm: dict, device: torch.device) -> None:
        ...
        self.features = nn.Sequential(InvertedResidualBlock(in_shape[1], 32, expansion_factor=2, stride=2, dropout_prob=dropout_prob), SqueezeExcitation(32, reduction=4), InvertedResidualBlock(32, 64, expansion_factor=2, stride=2, dropout_prob=dropout_prob), SqueezeExcitation(64, reduction=4)).to(device)
