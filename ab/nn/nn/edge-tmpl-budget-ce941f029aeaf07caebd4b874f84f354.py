...
class Head(nn.Module):
    def __init__(self, in_channels, num_classes, prm):
        ...
        self.depthwise = nn.Conv2d(128, 128, kernel_size=3, padding=1, groups=128, bias=False)
        self.bn2 = nn.BatchNorm2d(128)
        self.squeeze = nn.Conv2d(128, 32, kernel_size=1, bias=False)
        self.bn_squeeze = nn.BatchNorm2d(32)
        self.expand1 = nn.Conv2d(32, 64, kernel_size=1, bias=False)
        self.bn_expand1 = nn.BatchNorm2d(64)
        self.expand2 = nn.Conv2d(32, 64, kernel_size=1, bias=False)
        self.bn_expand2 = nn.BatchNorm2d(64)
