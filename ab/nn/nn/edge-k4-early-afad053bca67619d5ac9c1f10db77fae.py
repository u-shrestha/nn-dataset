...
class Net(nn.Module):
    ...
    def __init__(self, in_shape: tuple, out_shape: tuple, prm: dict, device: torch.device) -> None:
        ...
        self.features = nn.Sequential(FractalUnit(64, 64, 2, 0.15, dropout_prob), FractalUnit(64, 128, 2, 0.15, dropout_prob))
    ...
    def infer_dimensions_dynamically(self, in_shape, num_classes):
        ...
        with torch.no_grad():
            ...
            dim_fused = f_a.shape[1] + f_b.shape[1]
            del x_a, x_b
    ...
    def learn(self, train_data):
        ...
        try:
            ...
            del train_iter
            gc.collect()
supported_hyperparameters = {'batch': 32, 'dropout': 0.2, 'epoch': 1, 'lr': 0.01, 'momentum': 0.9, 'transform': 'norm_256_flip'}