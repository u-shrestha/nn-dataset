...
class Head(nn.Module):
    def __init__(self, in_channels, num_classes, prm):
        super().__init__()
        p = float(prm['dropout'])
        self.reduce_channels = nn.Conv2d(in_channels, 128, kernel_size=1, bias=False)
        ...
        self.pointwise = nn.Conv2d(128, 256, kernel_size=1, bias=False)
        self.bn_pointwise = nn.BatchNorm2d(256)
