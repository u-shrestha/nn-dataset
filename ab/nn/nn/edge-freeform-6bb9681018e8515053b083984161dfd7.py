...
class Net(nn.Module):
    ...
    def __init__(self, in_shape: tuple, out_shape: tuple, prm: dict, device: torch.device) -> None:
        ...
        self.features = nn.Sequential(nn.Conv2d(3, 16, kernel_size=3, stride=2, padding=1, bias=False), nn.BatchNorm2d(16), nn.ReLU6(inplace=True), InvertedResidualBlock(16, 32, stride=1, expand_ratio=2, dropout_prob=dropout_prob), SqueezeExcitation(32), InvertedResidualBlock(32, 64, stride=2, expand_ratio=2, dropout_prob=dropout_prob), SqueezeExcitation(64), nn.MaxPool2d(kernel_size=2, stride=2))
