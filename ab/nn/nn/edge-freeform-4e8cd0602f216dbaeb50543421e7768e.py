...
def se_block(in_channels, reduction_ratio=16):
    return nn.Sequential(nn.AdaptiveAvgPool2d(1), nn.LazyConv2d(in_channels // reduction_ratio, kernel_size=1, bias=False), nn.ReLU(inplace=True), nn.LazyConv2d(in_channels, kernel_size=1, bias=False), nn.Sigmoid())
