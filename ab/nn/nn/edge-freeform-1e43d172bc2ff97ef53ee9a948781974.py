...
class Net(nn.Module):
    ...
    def __init__(self, in_shape: tuple, out_shape: tuple, prm: dict, device: torch.device) -> None:
        ...
        self.features = nn.Sequential(InvertedResidualBlock(3, 32, stride=1, expand_ratio=6, dropout_prob=dropout_prob), DepthwiseSeparableBlock(32, 64, stride=2, dropout_prob=dropout_prob), SqueezeExcitation(64), EfficientUnit(64, 128, stride=2, expansion_factor=6, reduction_ratio=4, dropout_prob=dropout_prob))
