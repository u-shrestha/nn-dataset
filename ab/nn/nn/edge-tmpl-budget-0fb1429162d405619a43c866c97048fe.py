...
class Head(nn.Module):
    def __init__(self, in_channels, num_classes, prm):
        ...
        self.depthwise_conv1 = nn.Conv2d(192, 192, kernel_size=3, padding=1, groups=192, bias=False)
        ...
        self.depthwise_conv2 = nn.Conv2d(192, 192, kernel_size=3, padding=1, groups=192, bias=False)
