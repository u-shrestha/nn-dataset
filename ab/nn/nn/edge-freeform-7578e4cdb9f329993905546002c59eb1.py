...
class Net(nn.Module):
    ...
    def __init__(self, in_shape: tuple, out_shape: tuple, prm: dict, device: torch.device) -> None:
        ...
        self.features = nn.Sequential(InvertedResidual(3, 1, 64, 2), nn.Dropout2d(dropout_prob), InvertedResidual(64, 2, 128, 2), nn.Dropout2d(dropout_prob), InvertedResidual(128, 2, 256, 2), nn.Dropout2d(dropout_prob)).to(device)
