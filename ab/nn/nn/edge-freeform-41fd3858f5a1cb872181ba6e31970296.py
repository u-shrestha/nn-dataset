...
class EfficientBlock(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, expansion_factor=6, stride=1, dropout_prob=0.0):
        super().__init__()
        self.conv = inverted_residual_block(in_channels, out_channels, stride, expansion_factor, dropout_prob)
...
class Net(nn.Module):
    ...
    def __init__(self, in_shape: tuple, out_shape: tuple, prm: dict, device: torch.device) -> None:
        ...
        self.features = nn.Sequential(EfficientBlock(3, 32, stride=2, dropout_prob=dropout_prob), EfficientBlock(32, 64, stride=2, dropout_prob=dropout_prob), EfficientBlock(64, 128, stride=1, dropout_prob=dropout_prob), DepthwiseSeparableConv(128, 128, dropout_prob=dropout_prob))
    ...
    def forward(self, x: torch.Tensor, is_probing: bool=False) -> torch.Tensor:
        ...
        mid_img = torch.nn.functional.interpolate(mid_4d, size=(32, 32), mode='nearest')
