...
class Net(nn.Module):
    ...
    def __init__(self, in_shape: tuple, out_shape: tuple, prm: dict, device: torch.device) -> None:
        ...
        self.features = nn.Sequential(DSConv(3, 32, stride=1, padding=1, dropout_prob=dropout_prob), InvertedResidualBlock(32, 32, expansion_factor=1, stride=1, dropout_prob=dropout_prob), SEBlock(32), InvertedResidualBlock(32, 64, expansion_factor=4, stride=2, dropout_prob=dropout_prob), SEBlock(64))
