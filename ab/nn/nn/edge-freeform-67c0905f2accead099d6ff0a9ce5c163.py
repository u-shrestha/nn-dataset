...
class Net(nn.Module):
    ...
    def __init__(self, in_shape: tuple, out_shape: tuple, prm: dict, device: torch.device) -> None:
        ...
        self.backbone_b = TorchVision('shufflenet_v2_x1_0', in_channels=3, truncate=4).to(device)
        self.features = nn.Sequential(ds_conv3x3_block(3, 16, stride=1, padding=1, bias=False, dropout_prob=dropout_prob), InvertedResidualBlock(16, 24, stride=2, expand_ratio=2, dropout_prob=dropout_prob), SqueezeExcitation(24, 6), InvertedResidualBlock(24, 40, stride=2, expand_ratio=2, dropout_prob=dropout_prob), SqueezeExcitation(40, 10), nn.MaxPool2d(kernel_size=2, stride=2))
