...
class Head(nn.Module):
    def __init__(self, in_channels, num_classes, prm):
        super().__init__()
        p = float(prm['dropout'])
        self.dw_conv1 = nn.Conv2d(in_channels, in_channels, 3, padding=1, groups=in_channels, bias=False)
        self.bn1 = nn.BatchNorm2d(in_channels)
        self.pw_conv1 = nn.Conv2d(in_channels, in_channels * 2, 1, bias=False)
        ...
        self.dw_conv2 = nn.Conv2d(in_channels * 2, in_channels * 2, 3, padding=1, groups=in_channels * 2, bias=False)
