...
class Net(nn.Module):
    ...
    def __init__(self, in_shape: tuple, out_shape: tuple, prm: dict, device: torch.device) -> None:
        ...
        self.features = nn.Sequential(FractalUnit(3, 32, num_blocks=2, stride=1, expansion_factor=6), FractalUnit(32, 64, num_blocks=2, stride=2, expansion_factor=6), FractalUnit(64, 128, num_blocks=2, stride=2, expansion_factor=6))
