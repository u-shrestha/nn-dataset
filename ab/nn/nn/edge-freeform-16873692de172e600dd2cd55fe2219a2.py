...
class Net(nn.Module):
    ...
    def __init__(self, in_shape: tuple, out_shape: tuple, prm: dict, device: torch.device) -> None:
        ...
        self.features = nn.Sequential(inverted_residual_block(3, 16, stride=2, dropout_prob=dropout_prob), inverted_residual_block(16, 32, stride=2, dropout_prob=dropout_prob), DepthwiseSeparableConv(32, 32, dropout_prob=dropout_prob), DepthwiseSeparableConv(32, 64, stride=2, dropout_prob=dropout_prob), SqueezeExcitation(64, reduction_ratio=8))
