...
class Net(nn.Module):
    ...
    def __init__(self, in_shape: tuple, out_shape: tuple, prm: dict, device: torch.device) -> None:
        ...
        N = 3
        num_columns = 2
        element_list = ('nn.ReLU(inplace=True)', 'nn.Dropout2d(p=dropout_prob) if dropout_prob > 0 else nn.Identity()', 'nn.ReLU(inplace=True)') # Just for logging
        backbone_a_name = "mnasnet1_0"
        backbone_b_name = "vgg16_bn"
