...
class SEBlock(nn.Module):
    ...
    def __init__(self, in_channels, reduction_ratio=16):
        ...
        self.fc = nn.Sequential(nn.Conv2d(in_channels, in_channels // reduction_ratio, kernel_size=1, bias=False), nn.ReLU(inplace=True), nn.Conv2d(in_channels // reduction_ratio, in_channels, kernel_size=1, bias=False), nn.Sigmoid())
...
class Net(nn.Module):
    ...
    def __init__(self, in_shape: tuple, out_shape: tuple, prm: dict, device: torch.device) -> None:
        ...
        self.features = nn.Sequential(nn.Conv2d(3, 32, kernel_size=3, stride=2, padding=1, bias=False), nn.BatchNorm2d(32), nn.ReLU6(inplace=True), InvertedResidualBlock(32, 32, stride=1, expand_ratio=1, dropout_prob=dropout_prob), InvertedResidualBlock(32, 64, stride=2, expand_ratio=6, dropout_prob=dropout_prob), InvertedResidualBlock(64, 64, stride=1, expand_ratio=6, dropout_prob=dropout_prob), DepthwiseSeparableBlock(64, 32, stride=2, padding=1, bias=False, dropout_prob=dropout_prob), SEBlock(32), DepthwiseSeparableBlock(32, 16, stride=2, padding=1, bias=False, dropout_prob=dropout_prob), SEBlock(16))
        self.to(self.device)
