...
class Net(nn.Module):
    ...
    def __init__(self, in_shape: tuple, out_shape: tuple, prm: dict, device: torch.device) -> None:
        ...
        inverted_residual_setting = [InvertedResidualConfig(16, 3, 16, 16, True, 'RE', 2, 1, width_mult), InvertedResidualConfig(16, 3, 72, 24, False, 'RE', 2, 1, width_mult), InvertedResidualConfig(24, 3, 88, 24, False, 'RE', 1, 1, width_mult), InvertedResidualConfig(24, 5, 96, 40, True, 'HS', 2, 1, width_mult), InvertedResidualConfig(40, 5, 240, 40, True, 'HS', 1, 1, width_mult), InvertedResidualConfig(40, 5, 240, 40, True, 'HS', 1, 1, width_mult), InvertedResidualConfig(40, 5, 120, 48, True, 'HS', 1, 1, width_mult), InvertedResidualConfig(48, 5, 144, 48, True, 'HS', 1, 1, width_mult), InvertedResidualConfig(48, 5, 288, 96 // reduce_divider, True, 'HS', 2, dilation, width_mult), InvertedResidualConfig(96 // reduce_divider, 5, 576 // reduce_divider, 96 // reduce_divider, True, 'HS', 1, dilation, width_mult), InvertedResidualConfig(96 // reduce_divider, 5, 576 // reduce_divider, 96 // reduce_divider, True, 'HS', 1, dilation, width_mult)]
        ...
        layers.append(Conv2dNormActivation(in_shape[1], firstconv_output_channels, kernel_size=3, stride=2, norm_layer=norm_layer, activation_layer=nn.Hardswish))
...
def _mobilenet_v3(inverted_residual_setting: List[InvertedResidualConfig], last_channel: int, weights: Optional[WeightsEnum], progress: bool, **kwargs: Any) -> Net:
