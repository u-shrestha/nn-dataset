...
class Net(nn.Module):
    ...
    def __init__(self, in_shape: tuple, out_shape: tuple, prm: dict, device: torch.device) -> None:
        ...
        self.features = nn.Sequential(inverted_residual_block(576, 128, stride=1, expand_ratio=2, dropout_prob=dropout_prob), SEBlock(128), DepthwiseSeparableConv(128, 128, stride=1, padding=1), SEBlock(128), DepthwiseSeparableConv(128, 256, stride=2, padding=1))
