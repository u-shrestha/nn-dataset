...
def inverted_residual_block(in_channels, out_channels, stride, expansion_factor=6, dropout_prob=0.0):
...
class Net(nn.Module):
    ...
    def __init__(self, in_shape: tuple, out_shape: tuple, prm: dict, device: torch.device) -> None:
        ...
        for i, out_ch in enumerate(channels):
            ...
            self.features.add_module(f'squeeze_excitation_{i + 1}', se_block(out_ch))
            curr_ch = out_ch
