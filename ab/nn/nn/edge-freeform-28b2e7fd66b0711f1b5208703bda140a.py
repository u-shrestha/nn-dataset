...
class Net(nn.Module):
    ...
    def __init__(self, in_shape: tuple, out_shape: tuple, prm: dict, device: torch.device) -> None:
        ...
        self.features = nn.Sequential(DSConv(in_shape[1], 32, stride=1, padding=1, dropout_prob=dropout_prob), InvertedResidualBlock(32, 64, expansion_factor=2, stride=2, dropout_prob=dropout_prob), SEBlock(64), InvertedResidualBlock(64, 128, expansion_factor=2, stride=2, dropout_prob=dropout_prob), SEBlock(128))
