...
class InvertedResidualBlock(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, stride, expansion_factor, use_se=False, se_ratio=0.25):
        super().__init__()
...
class Net(nn.Module):
    ...
    def __init__(self, in_shape: tuple, out_shape: tuple, prm: dict, device: torch.device) -> None:
        ...
        self.features = nn.Sequential(DepthwiseSeparableBlock(576, 128, stride=2, expansion_factor=2), InvertedResidualBlock(128, 256, stride=2, expansion_factor=6, use_se=True), InvertedResidualBlock(256, 512, stride=2, expansion_factor=6, use_se=True))
