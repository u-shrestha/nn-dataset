...
class Head(nn.Module):
    def __init__(self, in_channels, num_classes, prm):
        ...
        self.bn_reduce = nn.BatchNorm2d(128)
        self.depthwise1 = nn.Conv2d(128, 128, kernel_size=3, padding=1, groups=128, bias=False)
        self.bn_depthwise1 = nn.BatchNorm2d(128)
        self.pointwise1 = nn.Conv2d(128, 256, kernel_size=1, bias=False)
        self.bn_pointwise1 = nn.BatchNorm2d(256)
        ...
        self.depthwise2 = nn.Conv2d(256, 256, kernel_size=3, padding=1, groups=256, bias=False)
        self.bn_depthwise2 = nn.BatchNorm2d(256)
        self.pointwise2 = nn.Conv2d(256, 128, kernel_size=1, bias=False)
        self.bn_pointwise2 = nn.BatchNorm2d(128)
