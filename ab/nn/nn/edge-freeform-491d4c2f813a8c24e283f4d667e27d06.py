...
class Net(nn.Module):
    ...
    def __init__(self, in_shape: tuple, out_shape: tuple, prm: dict, device: torch.device) -> None:
        ...
        self.features = nn.Sequential(DepthwiseSeparableConv(1600, 256), InvertedResidualBlock(256, 6, 128, stride=1), SqueezeExcitation(128), nn.MaxPool2d(kernel_size=2, stride=2), DepthwiseSeparableConv(128, 256), InvertedResidualBlock(256, 6, 64, stride=1), SqueezeExcitation(64), nn.MaxPool2d(kernel_size=2, stride=2))
