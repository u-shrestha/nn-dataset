...
class Net(nn.Module):
    ...
    def __init__(self, in_shape: tuple, out_shape: tuple, prm: dict, device: torch.device) -> None:
        ...
        self.features = nn.Sequential(DepthwiseSeparableConv(3, 32, stride=2), SEInvertedResidualBlock(32, 64, stride=2, dropout_prob=dropout_prob), SEInvertedResidualBlock(64, 128, stride=2, dropout_prob=dropout_prob)).to(device)
