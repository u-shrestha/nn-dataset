...
def inverted_residual_block(in_channels, out_channels, stride=1, expand_ratio=6, dropout_prob=0.0):
    ...
    if stride == 1 and in_channels == out_channels and (dropout_prob > 0):
...
class Net(nn.Module):
    ...
    def __init__(self, in_shape: tuple, out_shape: tuple, prm: dict, device: torch.device) -> None:
        ...
        self.features = nn.Sequential(DepthwiseSeparableBlock(3, 32, dropout_prob=dropout_prob), se_block(32), inverted_residual_block(32, 64, stride=2, expand_ratio=6, dropout_prob=dropout_prob), se_block(64), inverted_residual_block(64, 64, stride=1, expand_ratio=6, dropout_prob=dropout_prob), se_block(64))
