...
class Net(nn.Module):
    ...
    def __init__(self, in_shape: tuple, out_shape: tuple, prm: dict, device: torch.device) -> None:
        ...
        self.features = nn.Sequential(inverted_residual_block(in_channels=24, out_channels=32, stride=1, expand_ratio=6, dropout_prob=dropout_prob), depthwise_separable_block(in_channels=32, out_channels=48, stride=1, padding=1, bias=False, dropout_prob=dropout_prob), squeeze_excitation_block(in_channels=48, reduction_ratio=16))
