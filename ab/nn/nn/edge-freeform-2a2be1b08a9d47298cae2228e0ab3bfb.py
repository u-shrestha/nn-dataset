...
class SEBlock(nn.Module):
    ...
    def __init__(self, in_channels, reduction_ratio=16):
        ...
        self.se = nn.Sequential(nn.AdaptiveAvgPool2d((1, 1)), nn.LazyConv2d(in_channels // reduction_ratio, kernel_size=1, bias=False), nn.ReLU(inplace=True), nn.LazyConv2d(in_channels, kernel_size=1, bias=False), nn.Sigmoid())
