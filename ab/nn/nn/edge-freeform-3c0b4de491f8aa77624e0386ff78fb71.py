...
class Net(nn.Module):
    ...
    def __init__(self, in_shape: tuple, out_shape: tuple, prm: dict, device: torch.device) -> None:
        ...
        self.features = nn.Sequential(DepthwiseSeparableBlock(3, 64, dropout_prob=dropout_prob), se_block(64), inverted_residual_block(64, 128, stride=2, expand_ratio=6, dropout_prob=dropout_prob), se_block(128), inverted_residual_block(128, 128, stride=1, expand_ratio=6, dropout_prob=dropout_prob), se_block(128))
