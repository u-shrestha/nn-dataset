...
class Net(nn.Module):
    ...
    def __init__(self, in_shape: tuple, out_shape: tuple, prm: dict, device: torch.device) -> None:
        super().__init__()
        self.device = device
        self.pattern = 'Efficient_Parallel'
        ...
        self.features = nn.Sequential(inverted_residual_block(3, 16, stride=1, dropout_prob=dropout_prob), inverted_residual_block(16, 32, stride=2, dropout_prob=dropout_prob))
