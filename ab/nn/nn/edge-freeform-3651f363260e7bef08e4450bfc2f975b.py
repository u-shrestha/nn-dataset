...
class Net(nn.Module):
    ...
    def __init__(self, in_shape: tuple, out_shape: tuple, prm: dict, device: torch.device) -> None:
        ...
        self.features = nn.Sequential(drop_conv3x3_block(3, 32, stride=2, dropout_prob=dropout_prob), InvertedResidual(32, 64, expansion_factor=1, stride=1), InvertedResidual(64, 64, expansion_factor=1, stride=1), nn.MaxPool2d(kernel_size=2, stride=2))
