...
class Net(nn.Module):
    ...
    def __init__(self, in_shape: tuple, out_shape: tuple, prm: dict, device: torch.device) -> None:
        ...
        self.features = nn.Sequential(DepthwiseSeparableConv(3, 32, dropout_prob=dropout_prob), SEBlock(32), InvertedResidualBlock(32, 64, expansion_factor=2, stride=2), SEBlock(64), InvertedResidualBlock(64, 64, expansion_factor=2, stride=1), SEBlock(64), InvertedResidualBlock(64, 128, expansion_factor=2, stride=2), SEBlock(128)).to(device)
