...
class InvertedResidualSEBlock(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, stride, expand_ratio, dropout_prob=0.0):
        ...
        layers.extend([ds_conv3x3_block(hidden_dim, out_channels, stride=stride, bias=False, dropout_prob=dropout_prob), SEBlock(out_channels)])
...
class Net(nn.Module):
    ...
    def __init__(self, in_shape: tuple, out_shape: tuple, prm: dict, device: torch.device) -> None:
        ...
        self.features = nn.Sequential(ds_conv3x3_block(3, 16, stride=2, padding=1, bias=False, dropout_prob=dropout_prob), InvertedResidualSEBlock(16, 24, stride=1, expand_ratio=6, dropout_prob=dropout_prob), InvertedResidualSEBlock(24, 24, stride=1, expand_ratio=6, dropout_prob=dropout_prob))
