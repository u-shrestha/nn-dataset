...
class Head(nn.Module):
    def __init__(self, in_channels, num_classes, prm):
        ...
        self.conv_separable = nn.Conv2d(128, 128, kernel_size=3, padding=1, groups=128, bias=False)
        self.bn_conv_separable = nn.BatchNorm2d(128)
    ...
    def forward(self, x):
        ...
        x = x * se
        x = F.relu(self.bn_conv_separable(self.conv_separable(x)))
