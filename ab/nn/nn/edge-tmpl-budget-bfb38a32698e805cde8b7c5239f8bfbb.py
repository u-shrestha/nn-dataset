...
class Head(nn.Module):
    def __init__(self, in_channels, num_classes, prm):
        ...
        self.dw_conv = nn.Conv2d(160, 160, kernel_size=3, padding=1, groups=160, bias=False)
        self.bn_dw = nn.BatchNorm2d(160)
        ...
        self.conv_expand = nn.Conv2d(160, 256, kernel_size=1, bias=False)
