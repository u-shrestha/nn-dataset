...
class Net(nn.Module):
    ...
    def __init__(self, in_shape: tuple, out_shape: tuple, prm: dict, device: torch.device) -> None:
        ...
        self.features = nn.Sequential(ds_conv3x3_block(3, 24, stride=1, padding=1, bias=False, dropout_prob=dropout_prob), InvertedResidualBlock(24, 48, stride=2, expand_ratio=2, dropout_prob=dropout_prob), SqueezeExcitation(48), InvertedResidualBlock(48, 96, stride=2, expand_ratio=2, dropout_prob=dropout_prob), SqueezeExcitation(96))
