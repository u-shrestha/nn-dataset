...
class Head(nn.Module):
    def __init__(self, in_channels, num_classes, prm):
        ...
        self.conv1 = nn.Conv2d(256, 512, kernel_size=3, stride=2, padding=1, groups=256, bias=False)
        self.bn1 = nn.BatchNorm2d(512)
        self.conv2 = nn.Conv2d(512, 1024, kernel_size=3, stride=2, padding=1, groups=512, bias=False)
