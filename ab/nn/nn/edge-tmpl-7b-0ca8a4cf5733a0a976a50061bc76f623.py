...
class Head(nn.Module):
    def __init__(self, in_channels, num_classes, prm):
        super().__init__()
        p = float(prm['dropout'])
        self.projector = nn.Conv2d(in_channels, 64, kernel_size=1, bias=False)
        ...
        self.conv3x3 = nn.Conv2d(128, 256, kernel_size=3, padding=1, bias=False)
        self.bn3x3 = nn.BatchNorm2d(256)
