...
class Head(nn.Module):
    def __init__(self, in_channels, num_classes, prm):
        ...
        self.dwconv1 = nn.Conv2d(128, 128, kernel_size=3, padding=1, groups=128, bias=False)
        self.bn_dwconv1 = nn.BatchNorm2d(128)
        ...
        self.dwconv2 = nn.Conv2d(128, 128, kernel_size=3, padding=1, groups=128, bias=False)
        self.bn_dwconv2 = nn.BatchNorm2d(128)
