...
class SPBlock(nn.Module):
    ...
    def __init__(self, channels):
        super().__init__()
        self.c1 = nn.Conv2d(channels, 625, 1, padding=0)
        self.c2 = nn.Conv2d(625, channels, 1, padding=0)
        self.act = nn.GELU()
...
class Net(nn.Module):
    """Combined denoising architecture leveraging attention, lightweight denoising, and sub-pixel blocks."""
