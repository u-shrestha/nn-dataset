...
class Head(nn.Module):
    def __init__(self, in_channels, num_classes, prm):
        ...
        self.bn_dwconv1 = nn.BatchNorm2d(64)
        ...
        self.dw_conv2 = nn.Conv2d(64, 64, kernel_size=3, padding=1, groups=64, bias=False)
        self.bn_dwconv2 = nn.BatchNorm2d(64)
    ...
    def forward(self, x):
        ...
        x = self.bn_dwconv1(self.dw_conv1(x))
        x = self.se_block1(x) * x
        x = self.bn_dwconv2(self.dw_conv2(x))
        x = self.se_block2(x) * x
