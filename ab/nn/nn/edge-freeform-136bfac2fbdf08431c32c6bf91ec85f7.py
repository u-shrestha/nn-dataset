...
class Net(nn.Module):
    ...
    def __init__(self, in_shape: tuple, out_shape: tuple, prm: dict, device: torch.device) -> None:
        ...
        self.features = nn.Sequential(inverted_residual_block(256, 128, stride=1, expand_ratio=6, dropout_prob=dropout_prob), SEBlock(128), depthwise_separable_block(128, 64, dropout_prob=dropout_prob))
