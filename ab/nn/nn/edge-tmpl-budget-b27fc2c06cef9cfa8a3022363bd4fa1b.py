...
class Head(nn.Module):
    def __init__(self, in_channels, num_classes, prm):
        ...
        self.squeeze = nn.Conv2d(96, 16, kernel_size=1, bias=False)
        self.bn_squeeze = nn.BatchNorm2d(16)
        self.expand1 = nn.Conv2d(16, 64, kernel_size=1, bias=False)
        self.bn_expand1 = nn.BatchNorm2d(64)
...
class Net(nn.Module):
    def __init__(self, in_shape, out_shape, prm, device):
        ...
        self.backbone = _edge_backbone('mobilenet_v3_small', device)
