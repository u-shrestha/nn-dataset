...
class Net(nn.Module):
    ...
    def __init__(self, in_shape: tuple, out_shape: tuple, prm: dict, device: torch.device) -> None:
        ...
        self.features = nn.Sequential(inverted_residual_block(576, 64, stride=1, expansion_factor=6, dropout_prob=dropout_prob), FractalUnit(64, 128, num_columns=2, loc_drop_prob=0.15, dropout_prob=dropout_prob), inverted_residual_block(128, 256, stride=1, expansion_factor=6, dropout_prob=dropout_prob))
