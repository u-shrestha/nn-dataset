...
class Net(nn.Module):
    ...
    def __init__(self, in_shape: tuple, out_shape: tuple, prm: dict, device: torch.device) -> None:
        ...
        self.backbone_a = TorchVision('mobilenet_v3_small', in_channels=in_shape[1], truncate=4).to(device)
        self.features = nn.Sequential(DSConv(in_shape[1], 32, stride=1, padding=1, dropout_prob=dropout_prob), SEBlock(32), InvertedResidualBlock(32, 64, expansion_factor=6, stride=2, dropout_prob=dropout_prob), SEBlock(64), InvertedResidualBlock(64, 128, expansion_factor=6, stride=2, dropout_prob=dropout_prob), SEBlock(128))
