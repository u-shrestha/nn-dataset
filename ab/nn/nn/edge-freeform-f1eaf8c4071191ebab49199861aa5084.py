...
class Net(nn.Module):
    ...
    def __init__(self, in_shape: tuple, out_shape: tuple, prm: dict, device: torch.device) -> None:
        ...
        self.features = nn.Sequential(DepthwiseSeparableBlock(3, 64, dropout_prob=dropout_prob), SqueezeExcitation(64), InvertedResidualBlock(64, 128, stride=2, expand_ratio=2, dropout_prob=dropout_prob), SqueezeExcitation(128), InvertedResidualBlock(128, 128, stride=1, expand_ratio=2, dropout_prob=dropout_prob), SqueezeExcitation(128))
