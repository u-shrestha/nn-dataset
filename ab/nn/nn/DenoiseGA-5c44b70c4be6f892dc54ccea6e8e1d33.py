...
class Net(nn.Module):
    ...
    def __init__(self, in_shape=(1, 3, 256, 256), out_shape=None, prm={}, device='cuda'):
        ...
        self.conv2 = nn.Conv2d(in_channels=64, out_channels=97, kernel_size=3, padding=1)
        self.conv3 = nn.Conv2d(in_channels=97, out_channels=in_shape[1], kernel_size=3, padding=1)
