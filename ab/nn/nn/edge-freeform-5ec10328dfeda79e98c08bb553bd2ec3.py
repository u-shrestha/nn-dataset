...
class Net(nn.Module):
    ...
    def __init__(self, in_shape: tuple, out_shape: tuple, prm: dict, device: torch.device) -> None:
        ...
        self.features = nn.Sequential(EfficientBlock(3, 16, expansion_factor=1, stride=1, dropout_prob=dropout_prob), EfficientBlock(16, 32, expansion_factor=4, stride=2, dropout_prob=dropout_prob), EfficientBlock(32, 64, expansion_factor=4, stride=2, dropout_prob=dropout_prob), EfficientBlock(64, 128, expansion_factor=4, stride=2, dropout_prob=dropout_prob))
