...
class Head(nn.Module):
    def __init__(self, in_channels, num_classes, prm):
        ...
        self.expand = nn.Conv2d(192, 384, kernel_size=1, bias=False)
        self.bn_expand = nn.BatchNorm2d(384)
        self.se = nn.Sequential(
            nn.AdaptiveAvgPool2d(1),
            nn.Conv2d(384, 48, kernel_size=1, bias=True),
            nn.ReLU(inplace=True),
            nn.Conv2d(48, 384, kernel_size=1, bias=True),
            nn.Sigmoid()
        )
