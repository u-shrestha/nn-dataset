...
class Net(nn.Module):
    ...
    def __init__(self, in_shape: tuple, out_shape: tuple, prm: dict, device: torch.device) -> None:
        ...
        self.features = nn.Sequential(DepthwiseSeparableConv(3, 16, stride=2, dropout_prob=dropout_prob), SEInvertedResidual(16, 24, stride=2, dropout_prob=dropout_prob), SEInvertedResidual(24, 24, stride=1, dropout_prob=dropout_prob), SEInvertedResidual(24, 32, stride=2, dropout_prob=dropout_prob), SEInvertedResidual(32, 32, stride=1, dropout_prob=dropout_prob), SEInvertedResidual(32, 32, stride=1, dropout_prob=dropout_prob), SEInvertedResidual(32, 64, stride=2, dropout_prob=dropout_prob), SEInvertedResidual(64, 64, stride=1, dropout_prob=dropout_prob), SEInvertedResidual(64, 64, stride=1, dropout_prob=dropout_prob), SEInvertedResidual(64, 64, stride=1, dropout_prob=dropout_prob))
