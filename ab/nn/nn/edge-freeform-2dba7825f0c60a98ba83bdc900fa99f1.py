...
class Net(nn.Module):
    ...
    def __init__(self, in_shape: tuple, out_shape: tuple, prm: dict, device: torch.device) -> None:
        ...
        self.features = nn.Sequential(ds_conv3x3_block(3, 16, stride=1, padding=1, bias=False, dropout_prob=dropout_prob), InvertedResidualBlock(16, 24, stride=1, expand_ratio=2, dropout_prob=dropout_prob), InvertedResidualBlock(24, 24, stride=2, expand_ratio=1, dropout_prob=dropout_prob), SEBlock(24), InvertedResidualBlock(24, 40, stride=1, expand_ratio=2, dropout_prob=dropout_prob), InvertedResidualBlock(40, 40, stride=2, expand_ratio=1, dropout_prob=dropout_prob), SEBlock(40))
