...
class Net(nn.Module):
    ...
    def __init__(self, in_shape: tuple, out_shape: tuple, prm: dict, device: torch.device) -> None:
        ...
        self.features = nn.Sequential(DepthwiseSeparableBlock(1600, 128, dropout_prob=dropout_prob), nn.MaxPool2d(kernel_size=2, stride=2), DepthwiseSeparableBlock(128, 64, dropout_prob=dropout_prob))
