...
class Net(nn.Module):
    ...
    def __init__(self, in_shape: tuple, out_shape: tuple, prm: dict, device: torch.device) -> None:
        ...
        for name, repeats, output_channels_stage in zip(stage_names, stages_repeats, stages_out_channels[1:]):
            seq = [inverted_residual(input_channels, output_channels_stage, 2)]
            for i in range(repeats - 1):
                seq.append(inverted_residual(output_channels_stage, output_channels_stage, 1))
...
def _shufflenetv2(weights: Optional[WeightsEnum], progress: bool, *args: Any, **kwargs: Any) -> Net:
