...
class InvertedResidualBlock(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, expansion_factor=6, stride=1, dropout_prob=0.0):
        ...
        self.conv = nn.Sequential(DepthwiseSeparableBlock(in_channels, expanded_channels, stride=1), DepthwiseSeparableBlock(expanded_channels, expanded_channels, stride=stride, dropout_prob=dropout_prob), DepthwiseSeparableBlock(expanded_channels, out_channels, stride=1))
...
class Net(nn.Module):
    ...
    def __init__(self, in_shape: tuple, out_shape: tuple, prm: dict, device: torch.device) -> None:
        ...
        self.features = nn.Sequential(DepthwiseSeparableBlock(3, 64, stride=2, dropout_prob=dropout_prob), EfficientBlock(64, 128, stride=2), EfficientBlock(128, 128, stride=1))
        self.to(self.device)
