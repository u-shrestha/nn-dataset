...
class Net(nn.Module):
    ...
    def __init__(self, in_shape: tuple, out_shape: tuple, prm: dict, device: torch.device) -> None:
        ...
        self.features = nn.Sequential(DepthwiseSeparableConv(in_shape[1], 32, stride=1, padding=1, dropout_prob=dropout_prob), SqueezeExcitation(32), InvertedResidual(32, 64, stride=2, dropout_prob=dropout_prob), DepthwiseSeparableConv(64, 64, stride=1, padding=1, dropout_prob=dropout_prob), SqueezeExcitation(64), InvertedResidual(64, 128, stride=2, dropout_prob=dropout_prob))
