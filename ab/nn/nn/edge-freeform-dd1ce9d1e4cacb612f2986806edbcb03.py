...
class Net(nn.Module):
    ...
    def __init__(self, in_shape: tuple, out_shape: tuple, prm: dict, device: torch.device) -> None:
        ...
        self.features = nn.Sequential(FractalUnit(in_shape[1], 32, num_blocks=2, stride=1, expansion_factor=6), FractalUnit(32, 64, num_blocks=2, stride=2, expansion_factor=6), DepthwiseSeparableConv(64, 64, stride=1), nn.AdaptiveAvgPool2d((1, 1)), nn.Flatten())
