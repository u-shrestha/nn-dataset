...
class Net(nn.Module):
    ...
    def __init__(self, in_shape: tuple, out_shape: tuple, prm: dict, device: torch.device) -> None:
        ...
        self.features = nn.Sequential(DepthwiseSeparableConv(3, 64, stride=1, padding=1), SqueezeExcitation(64), InvertedResidualBlock(64, 64, expansion_factor=2, stride=2), SqueezeExcitation(64), InvertedResidualBlock(64, 128, expansion_factor=2, stride=2), SqueezeExcitation(128)).to(device)
