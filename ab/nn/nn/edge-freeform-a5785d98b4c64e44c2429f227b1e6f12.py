...
class InvertedResidualBlock(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, expansion_factor=6, stride=1, dropout_prob=0.0):
        ...
        layers.extend([DepthwiseSeparableConv(hidden_dim, out_channels, stride=stride, bias=False, dropout_prob=dropout_prob)])
...
class SEInvertedResidualBlock(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, expansion_factor=6, stride=1, dropout_prob=0.0):
        ...
        self.conv = nn.Sequential(DepthwiseSeparableConv(in_channels, expanded_channels, stride=stride, bias=False, dropout_prob=dropout_prob), SqueezeExcitation(expanded_channels), DepthwiseSeparableConv(expanded_channels, out_channels, stride=1, bias=False, dropout_prob=dropout_prob))
        self.dropout = nn.Dropout2d(p=dropout_prob) if dropout_prob > 0 else nn.Identity()
...
class Net(nn.Module):
    ...
    def __init__(self, in_shape: tuple, out_shape: tuple, prm: dict, device: torch.device) -> None:
        ...
        self.features = nn.Sequential(DepthwiseSeparableConv(3, 32, stride=1, padding=1, bias=False, dropout_prob=dropout_prob), SEInvertedResidualBlock(32, 64, stride=2, dropout_prob=dropout_prob), SEInvertedResidualBlock(64, 64, stride=1, dropout_prob=dropout_prob), SEInvertedResidualBlock(64, 128, stride=2, dropout_prob=dropout_prob), SEInvertedResidualBlock(128, 128, stride=1, dropout_prob=dropout_prob))
        self.to(self.device)
