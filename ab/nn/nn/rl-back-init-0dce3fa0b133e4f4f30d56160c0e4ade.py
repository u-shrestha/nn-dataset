...
class Net(nn.Module):
    ...
    def __init__(self, in_shape: tuple, out_shape: tuple, prm: dict, device: torch.device) -> None:
        ...
        N = 3
        num_columns = 2
        element_list = ('nn.Conv2d(in_channels, out_channels, kernel_size=3, stride=stride, padding=padding, bias=bias)', 'nn.ReLU(inplace=True)', 'nn.BatchNorm2d(out_channels)') # Just for logging
        backbone_a_name = "regnet_y_800mf"
        backbone_b_name = "resnext101_32x8d"
