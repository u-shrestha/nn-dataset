...
class Head(nn.Module):
    def __init__(self, in_channels, num_classes, prm):
        ...
        self.squeeze = nn.Conv2d(256, 64, kernel_size=1, bias=False)
        self.bn_squeeze = nn.BatchNorm2d(64)
        self.expand = nn.Conv2d(64, 256, kernel_size=1, bias=False)
        self.bn_expand = nn.BatchNorm2d(256)
    ...
    def forward(self, x):
        ...
        x = self.relu(self.bn_expand(self.expand(x)))
...
class Net(nn.Module):
    def __init__(self, in_shape, out_shape, prm, device):
        ...
        self.backbone = _edge_backbone('shufflenet_v2_x0_5', device)
