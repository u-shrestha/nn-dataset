...
class Head(nn.Module):
    def __init__(self, in_channels, num_classes, prm):
        ...
        self.dw_conv = nn.Conv2d(256, 256, kernel_size=3, stride=1, padding=1, groups=256, bias=False)
        self.exp_conv = nn.Conv2d(256, 512, kernel_size=1, bias=False)
        self.se = SqueezeAndExcitation(512, reduction_ratio=16)
