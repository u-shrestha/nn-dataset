...
class Net(nn.Module):
    ...
    def __init__(self, in_shape: tuple, out_shape: tuple, prm: dict, device: torch.device) -> None:
        super().__init__()
        self.device = device
        self.pattern = 'Mobile_Squeeze_Ensemble'
        ...
        self.features = nn.Sequential(inverted_residual_block(3, 16, stride=1), inverted_residual_block(16, 24, stride=2), inverted_residual_block(24, 40, stride=2), inverted_residual_block(40, 80, stride=2), inverted_residual_block(80, 96, stride=1), inverted_residual_block(96, 192, stride=2), inverted_residual_block(192, 320, stride=1)).to(device)
