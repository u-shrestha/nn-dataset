...
class InvertedResidualBlock(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, expansion_factor=6, stride=1, dropout_prob=0.0):
        ...
        self.stride = stride
        self.expanded_channels = expansion_factor * in_channels
...
class Net(nn.Module):
    ...
    def __init__(self, in_shape: tuple, out_shape: tuple, prm: dict, device: torch.device) -> None:
        ...
        self.features = nn.Sequential(DepthwiseSeparableConv(3, 32, stride=1, dropout_prob=dropout_prob), InvertedResidualBlock(32, 64, expansion_factor=6, stride=2, dropout_prob=dropout_prob), SqueezeExcitation(64), DepthwiseSeparableConv(64, 64, stride=1, dropout_prob=dropout_prob), InvertedResidualBlock(64, 128, expansion_factor=6, stride=2, dropout_prob=dropout_prob), SqueezeExcitation(128))
        self.to(self.device)
