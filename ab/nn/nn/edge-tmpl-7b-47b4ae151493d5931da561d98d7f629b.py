...
class Head(nn.Module):
    def __init__(self, in_channels, num_classes, prm):
        ...
        self.shuffle = Shuffle(256, groups=8)
        self.conv1 = nn.Conv2d(256, 256, kernel_size=3, padding=1, groups=256, bias=False)
        self.bn1 = nn.BatchNorm2d(256)
        self.se = SELayer(256, reduction=16)
        self.conv2 = nn.Conv2d(256, 1024, kernel_size=1, bias=False)
