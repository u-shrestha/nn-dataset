...
class Head(nn.Module):
    def __init__(self, in_channels, num_classes, prm):
        super().__init__()
        p = float(prm['dropout'])
        self.reduce_dim = nn.Conv2d(in_channels, 64, 1, bias=False)
        self.bn1 = nn.BatchNorm2d(64)
        self.relu = nn.ReLU(inplace=True)
        self.depthwise_conv1 = nn.Conv2d(64, 64, 3, padding=1, groups=64, bias=False)
        ...
        self.depthwise_conv2 = nn.Conv2d(64, 64, 3, padding=1, groups=64, bias=False)
