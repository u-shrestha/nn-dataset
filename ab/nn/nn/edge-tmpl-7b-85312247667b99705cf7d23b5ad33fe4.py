...
class Head(nn.Module):
    def __init__(self, in_channels, num_classes, prm):
        ...
        self.conv1 = nn.Conv2d(256, 256, 3, stride=1, padding=1, groups=256, bias=False)
        self.bn1 = nn.BatchNorm2d(256)
        self.conv2 = nn.Conv2d(256, 256, 3, stride=1, padding=1, groups=256, bias=False)
        self.bn2 = nn.BatchNorm2d(256)
        self.se = SEBlock(256, reduction_ratio=16)
