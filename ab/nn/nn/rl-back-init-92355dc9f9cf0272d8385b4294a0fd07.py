...
class Net(nn.Module):
    ...
    def __init__(self, in_shape: tuple, out_shape: tuple, prm: dict, device: torch.device) -> None:
        ...
        N = 3
        num_columns = 2
        element_list = ('nn.Dropout2d(p=dropout_prob) if dropout_prob > 0 else nn.Identity()', 'nn.Conv2d(in_channels, out_channels, kernel_size=3, stride=stride, padding=padding, bias=bias)', 'nn.ReLU(inplace=True)') # Just for logging
        backbone_a_name = "mnasnet1_0"
        backbone_b_name = "mobilenet_v2"
