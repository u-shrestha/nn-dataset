...
class Net(nn.Module):
    ...
    def __init__(self, in_shape: tuple, out_shape: tuple, prm: dict, device: torch.device) -> None:
        ...
        N = 3
        num_columns = 2
        element_list = ('nn.Conv2d(in_channels, out_channels, kernel_size=3, stride=stride, padding=padding, bias=bias)', 'nn.BatchNorm2d(out_channels)', 'nn.BatchNorm2d(out_channels)') # Just for logging
