...
class Net(nn.Module):
    ...
    def __init__(self, in_shape: tuple, out_shape: tuple, prm: dict, device: torch.device) -> None:
        ...
        self.features = nn.Sequential(depthwise_separable_block(in_channels=3, out_channels=64, dropout_prob=dropout_prob), inverted_residual_block(in_channels=64, out_channels=64, stride=1, dropout_prob=dropout_prob), squeeze_excitation_block(in_channels=64))
