...
class Net(nn.Module):
    ...
    def __init__(self, in_shape: tuple, out_shape: tuple, prm: dict, device: torch.device) -> None:
        ...
        self.features = nn.Sequential(DepthwiseSeparableConv(3, 32, dropout_prob=dropout_prob), InvertedResidualBlock(32, 64, stride=2, expansion=6, dropout_prob=dropout_prob), SqueezeExcitation(64), InvertedResidualBlock(64, 128, stride=2, expansion=6, dropout_prob=dropout_prob), SqueezeExcitation(128))
